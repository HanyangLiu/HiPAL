...
class dataEmbedding(Layer):
    def __init__(self, embedding_matrix,
        ...
        if agg_mode == 'concat':
            ...
            self.agg_layer = layers.Add(axis=2, name='lower_agg')
        else:
...
class nestedLowerEncoding(Layer):
    ...
    def build(self, input_shape):
        ...
        self.encoder = TCN(nb_filters=64,
                             nb_stacks=3,
                             dilations=[3 ** i for i in range(5)],
                             kernel_size=7,
                             dropout_rate=self.dropout,
                             return_sequences=False,
                             use_weight_norm=True)
        print('ResTCN receptive field size =', self.encoder.receptive_field)
...
class lowerModel:
    ...
    def build(self):
        self.lower_decoder = TCN(nb_filters=64,
                             nb_stacks=3,
                             dilations=[3 ** i for i in range(5)],
                             kernel_size=7,
                             dropout_rate=self.dropout,
                             ...
                             use_weight_norm=True)
        print('ResTCN receptive field size =', self.lower_decoder.receptive_field)
