...
from utils.util_hitcn_emb_variants import buildHierTCN, inner_ce_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument('--memo', type=str, default='testing')
    ...
    parser.add_argument('--pretrain_model', type=str, default='hier_restcn')
    ...
    parser.add_argument('--emb_mode', type=str, default='None')
    parser.add_argument('--agg_mode', type=str, default='add')
    parser.add_argument('--if_emb_pre', type=boolean_string, default=True)
